...
ActiveRecord::Schema.define(version: 20_150_526_164_516) do
  ...
  add_index 'activities', %w(type_id user_id notice_id reply_id), name: 'index_activities_unique_key', unique: true
  ...
  add_index 'advertisements', %w(started_on ended_on), name: 'index_advertisements_on_started_on_and_ended_on'
  ...
  add_index 'approvals', %w(approvable_type approvable_id), name: 'index_approvals_on_approvable_type_and_approvable_id'
  ...
  add_index 'identities', %w(provider uid), name: 'index_identities_on_provider_and_uid', unique: true
  ...
  add_index 'notice_tags', %w(notice_id tag_id), name: 'index_notice_tags_on_notice_id_and_tag_id'
  add_index 'notice_tags', %w(tag_id notice_id), name: 'index_notice_tags_on_tag_id_and_notice_id'
